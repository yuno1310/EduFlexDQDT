...
public class Keys {
    ...
    public static final UniqueKey<LearnerProfileRecord> LEARNER_PROFILE_PKEY = Internal.createUniqueKey(LearnerProfile.LEARNER_PROFILE, DSL.name("learner_profile_pkey"), new TableField[] { LearnerProfile.LEARNER_PROFILE.LEARNER_ID }, true);
    ...
    public static final ForeignKey<LearnerProfileRecord, UsersRecord> LEARNER_PROFILE__FK_LEARNER_USER = Internal.createForeignKey(LearnerProfile.LEARNER_PROFILE, DSL.name("fk_learner_user"), new TableField[] { LearnerProfile.LEARNER_PROFILE.LEARNER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true);
