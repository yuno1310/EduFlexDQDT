...
public class Keys {
    ...
    public static final UniqueKey<DailyQuestsRecord> DAILY_QUESTS_PKEY = Internal.createUniqueKey(DailyQuests.DAILY_QUESTS, DSL.name("daily_quests_pkey"), new TableField[] { DailyQuests.DAILY_QUESTS.ID }, true);
    ...
    public static final UniqueKey<UserDailyQuestProgressRecord> USER_DAILY_QUEST_PROGRESS_PKEY = Internal.createUniqueKey(UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS, DSL.name("user_daily_quest_progress_pkey"), new TableField[] { UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS.ID }, true);
    public static final UniqueKey<UserDailyQuestProgressRecord> USER_DAILY_QUEST_PROGRESS_USER_ID_QUEST_ID_QUEST_DATE_KEY = Internal.createUniqueKey(UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS, DSL.name("user_daily_quest_progress_user_id_quest_id_quest_date_key"), new TableField[] { UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS.USER_ID, UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS.QUEST_ID, UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS.QUEST_DATE }, true);
    ...
    public static final ForeignKey<LessonRecord, LessonRecord> LESSON__FK_LESSON_PARENT = Internal.createForeignKey(Lesson.LESSON, DSL.name("fk_lesson_parent"), new TableField[] { Lesson.LESSON.PARENT_LESSON_ID }, Keys.LESSON_PKEY, new TableField[] { Lesson.LESSON.LESSON_ID }, true);
    ...
    public static final ForeignKey<UserDailyQuestProgressRecord, DailyQuestsRecord> USER_DAILY_QUEST_PROGRESS__USER_DAILY_QUEST_PROGRESS_QUEST_ID_FKEY = Internal.createForeignKey(UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS, DSL.name("user_daily_quest_progress_quest_id_fkey"), new TableField[] { UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS.QUEST_ID }, Keys.DAILY_QUESTS_PKEY, new TableField[] { DailyQuests.DAILY_QUESTS.ID }, true);
    public static final ForeignKey<UserDailyQuestProgressRecord, UsersRecord> USER_DAILY_QUEST_PROGRESS__USER_DAILY_QUEST_PROGRESS_USER_ID_FKEY = Internal.createForeignKey(UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS, DSL.name("user_daily_quest_progress_user_id_fkey"), new TableField[] { UserDailyQuestProgress.USER_DAILY_QUEST_PROGRESS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true);
}
