...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>public.users.note</code>.
     */
    ...
    public UserDailyQuestProgressPath userDailyQuestProgress() {
        if (_userDailyQuestProgress == null)
            _userDailyQuestProgress = new UserDailyQuestProgressPath(this, null, Keys.USER_DAILY_QUEST_PROGRESS__USER_DAILY_QUEST_PROGRESS_USER_ID_FKEY.getInverseKey());
