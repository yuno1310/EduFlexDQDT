...
public class Courses extends TableImpl<CoursesRecord> {
     ...
     */
    public final TableField<CoursesRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.courses.description</code>.
     */
    public final TableField<CoursesRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR(1000), this, "");

    /**
     * The column <code>public.courses.image_url</code>.
     */
    public final TableField<CoursesRecord, String> IMAGE_URL = createField(DSL.name("image_url"), SQLDataType.VARCHAR(500), this, "");
     ...
     */
    @Deprecated
    public final TableField<CoursesRecord, Object> EMBEDDING = createField(DSL.name("embedding"), DefaultDataType.getDefaultDataType("\"public\".\"vector\""), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_COURSES_EMBEDDING);
    }

    @Override
    public Identity<CoursesRecord, Long> getIdentity() {
        return (Identity<CoursesRecord, Long>) super.getIdentity();
    }
